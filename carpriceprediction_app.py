...
import pandas as pd
import numpy as np
from PIL import Image #new version is pillow
import pickle
import xgboost
...
<h2 style="color:white;text-align:center;"> 2nd Hand Car Price Prediction App </h2>
</div><br>"""
...
html_temp = """
<div style="background-color:tomato;padding:1.5px">
<h2 style="color:white;text-align:center;"> Arguments for the Prediction </h2>
</div><br>"""
...
filename = 'carpriceXGB_model.pkl'
